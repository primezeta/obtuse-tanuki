...
void ACosmicSafariPawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("Thrust", this, &ACosmicSafariPawn::ThrustInput);
	InputComponent->BindAxis("MoveUp", this, &ACosmicSafariPawn::MoveUpInput);
	InputComponent->BindAxis("MoveRight", this, &ACosmicSafariPawn::MoveRightInput);
}

void ACosmicSafariPawn::ThrustInput(float Val)
{
	// Is there no input?
...
void ACosmicSafariPawn::MoveUpInput(float Val)
{
...
void ACosmicSafariPawn::MoveRightInput(float Val)
{
